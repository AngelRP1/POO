...
public class p_debito6 extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel lblTitular = new JLabel("<html><i>Nombre del préstamo</i><br><b>Crédito Hipotecario</b></html>", SwingConstants.CENTER);
        lblTitular.setFont(new Font("Segoe UI", Font.PLAIN, 18));
        lblTitular.setBounds(0, 310, 440, 50);
        comprobante.add(lblTitular);

        JLabel numero = new JLabel("CLAVE: 4567823489", SwingConstants.CENTER);
        ...
        JLabel lblImporte = new JLabel("<html><i>Importe del pago</i><br><b>$4,800</b></html>", SwingConstants.CENTER);
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Comprobante de Pago con Tarjeta");
        frame.setContentPane(new p_debito6(banco));
