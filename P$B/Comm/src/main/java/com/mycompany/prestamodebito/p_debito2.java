...
import com.mycompany.prestamodebito.p_debito3;
import com.mycompany.comm.Connection;
import javax.swing.*;
import java.awt.*;

public class p_debito2 extends JPanel {
    ...
    public p_debito2(Connection database) { 
        this.banco = database;
    ...
    private void initComponents() {
        ...
        titulo.setBounds(420, 160, 700, 40);
        this.add(titulo);

        JLabel subtitulo = new JLabel("Digita la referencia que aparece en tu recibo");
        subtitulo.setFont(new Font("Segoe UI", Font.PLAIN, 24));
        subtitulo.setForeground(Color.WHITE);
        subtitulo.setBounds(460, 200, 600, 40);
        this.add(subtitulo);
        ...
        JLabel labelReferencia = new JLabel("Referencia del préstamo");
        ...
        JLabel hint = new JLabel("Ingresa la referencia para validar el adeudo");
