...
public class p_debito3 extends JPanel {
    ...
    public p_debito3(Connection database) { 
        this.banco = database;
    ...
    private void initComponents() {
        ...
        JLabel subtitulo = new JLabel("Ingresa el motivo del pago relacionado a tu préstamo");
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Motivo del Pago del Préstamo");
