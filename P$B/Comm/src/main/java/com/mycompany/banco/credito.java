...
import com.mycompany.banco.insertartarjeta;
import com.mycompany.banco.pagar;
...
public class credito extends JPanel {
    ...
    public credito(Connection database) {
        this.banco = database;
    ...
    private void initComponents() {
        ...
        JLabel titulo = new JLabel("Pago de tarjeta de crédito");
        ...
        // Botón salir
        JButton btnSalir = crearBotonTexto("Salir", new Color(225, 40, 27));
        ...
        // Botón efectivo
        JButton btnEfectivo = crearBotonTexto("Efectivo", new Color(10, 123, 196));
        btnEfectivo.setBounds(1000, 610, 350, 70);
        this.add(btnEfectivo);

        // Botón tarjeta débito (actualizado a insertartarjeta)
        JButton btnDebito = crearBotonTexto("Tarjeta P$B débito", new Color(10, 123, 196));
        btnDebito.setBounds(1000, 520, 350, 70);
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Pago de crédito");
