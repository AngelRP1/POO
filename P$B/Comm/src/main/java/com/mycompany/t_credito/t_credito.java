...
public class t_credito extends JPanel {
    ...
    public t_credito(Connection database) { 
        this.banco = database;
    ...
    private void initComponents() {
        ...
        // Títulos
        JLabel titulo = new JLabel("¿ Eres tú, DIEGO SALAS ?", SwingConstants.CENTER);
        titulo.setFont(new Font("Segoe UI", Font.BOLD, 38));
        titulo.setForeground(Color.WHITE);
        titulo.setBounds(0, 300, 1440, 40);
        this.add(titulo);
        ...
        subtitulo.setBounds(0, 350, 1440, 30);
        this.add(subtitulo);
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new t_credito(banco));
