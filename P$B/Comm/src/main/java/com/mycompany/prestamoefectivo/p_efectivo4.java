...
public class p_efectivo4 extends JPanel {
    ...
    public p_efectivo4(Connection database) { 
        this.banco = database;
    ...
    private void initComponents() {
        ...
        JLabel titulo = new JLabel("Importe del préstamo");
        ...
        JLabel subtitulo = new JLabel("Ingresa el monto exacto a pagar por el préstamo");
        ...
        JLabel lblTitulo = new JLabel("DATOS DEL PRÉSTAMO", SwingConstants.CENTER);
        lblTitulo.setFont(new Font("Segoe UI", Font.BOLD, 16));
        lblTitulo.setBounds(0, 20, 450, 30);
        panelPago.add(lblTitulo);

        JLabel lblServicio = new JLabel("Nombre del beneficiario", SwingConstants.CENTER);
        lblServicio.setFont(new Font("Segoe UI", Font.ITALIC, 14));
        lblServicio.setBounds(0, 60, 450, 30);
        panelPago.add(lblServicio);

        JLabel lblClave = new JLabel("Antonio Manzano", SwingConstants.CENTER);
        lblClave.setFont(new Font("Segoe UI", Font.PLAIN, 16));
        lblClave.setBounds(0, 85, 450, 30);
        panelPago.add(lblClave);

        JLabel lblNumero = new JLabel("ID Préstamo: 1234567", SwingConstants.CENTER);
        ...
        JLabel lblIngresa = new JLabel("Ingrese", SwingConstants.CENTER);
        lblIngresa.setFont(new Font("Segoe UI", Font.PLAIN, 16));
        lblIngresa.setBounds(0, 245, 450, 30);
        panelPago.add(lblIngresa);

        JLabel aviso = new JLabel("ⓘ Capture el importe exacto del recibo del préstamo", SwingConstants.CENTER);
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Pago Préstamo - Monto");
        frame.setContentPane(new p_efectivo4(banco));
