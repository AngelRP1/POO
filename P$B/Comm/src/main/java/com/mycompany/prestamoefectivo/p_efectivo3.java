...
public class p_efectivo3 extends JPanel {
    ...
    public p_efectivo3(Connection database) { 
        this.banco = database;
    ...
    private void initComponents() {
        ...
        JLabel titulo = new JLabel("Motivo del pago del préstamo");
        titulo.setFont(new Font("Segoe UI", Font.BOLD, 36));
        titulo.setForeground(Color.WHITE);
        titulo.setBounds(430, 160, 700, 40);
        this.add(titulo);

        JLabel subtitulo = new JLabel("Ingresa la razón por la cual estás realizando este pago");
        subtitulo.setFont(new Font("Segoe UI", Font.PLAIN, 24));
        subtitulo.setForeground(Color.WHITE);
        subtitulo.setBounds(400, 200, 800, 30);
        this.add(subtitulo);
        ...
        JLabel labelMotivo = new JLabel("Motivo del Pago");
