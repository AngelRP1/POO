...
public class p_efectivo extends JPanel {
    ...
    public p_efectivo(Connection database) { 
        this.banco = database;
    ...
    private void initComponents() {
        ...
        JLabel titulo = new JLabel("Pago de préstamo en efectivo");
        ...
        JLabel subtitulo = new JLabel("Ingresa el número de préstamo a pagar");
        ...
        panelConvenio.setBounds(370, 300, 700, 200);
        panelConvenio.setLayout(null);

        JLabel labelConvenio = new JLabel("Número de préstamo");
        labelConvenio.setFont(new Font("Segoe UI", Font.PLAIN, 20));
        labelConvenio.setForeground(Color.WHITE);
        ...
        JLabel hintConvenio = new JLabel("Ingresa el número asignado a tu préstamo");
