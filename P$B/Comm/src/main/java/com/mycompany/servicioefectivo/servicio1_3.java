...
import com.mycompany.servicioefectivo.servicio1_2;
import java.awt.*;
import javax.swing.*;

public class servicio1_3 extends JPanel {
    ...
    public servicio1_3(Connection database, String convenio, String referencia) { 
    ...
    private void initComponents() {
        ...
        // Títulos
        JLabel titulo = new JLabel("Ingresa el servicio de pago");
        ...
        JLabel subtitulo = new JLabel("Ingresa tu servicio de pago");
        ...
        panelMotivo.setBounds(370, 300, 700, 200); // centrado
        ...
        btnRegresar.addActionListener(e -> {
            ...
            frame.setContentPane(new servicio1_2(banco, ""));
            frame.revalidate();
        });
        ...
        btnContinuar.addActionListener(e -> {
            JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(this);
            frame.setContentPane(new servicio1_4(banco, convenio, referencia, txtMotivo.getText()));
            frame.revalidate();
        });
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new servicio1_3(banco, convenio, referencia));
