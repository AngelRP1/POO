...
public class servicio1_2 extends JPanel {
    ...
    public servicio1_2(Connection database, String convenio) { 
    ...
    private void initComponents() {
        ...
        // Título
        JLabel titulo = new JLabel("Captura la referencia");
        ...
        JLabel subtitulo = new JLabel("Captura la referencia de tu recibo");
        ...
        // Panel de entrada similar a servicio1
        JPanel panelReferencia = new JPanel();
        panelReferencia.setBackground(new Color(10, 123, 196));
        panelReferencia.setBounds(370, 300, 700, 200); // centrado
        ...
        labelReferencia.setForeground(Color.WHITE); // blanco
        ...
        JLabel hint = new JLabel("Ingresa el número de referencia del recibo");
        ...
        btnContinuar.setBounds(1050, 700, 300, 70);
        btnContinuar.addActionListener(e -> {
            JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(this);
            frame.setContentPane(new servicio1_3(banco, convenio, txtReferencia.getText()));
            frame.revalidate();
        });
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Referencia");
        frame.setUndecorated(true);
        frame.setContentPane(new servicio1_2(banco, convenio));
